...
from database_setup import City, Base, Event
...
city2 = City(name = "New York", state="New York")

session.add(city2)
session.commit()


event1 = Event(name = "Droidcon New York 2015", description = "The Droidcon conferences around the world support the Android platform and create a global network for developers and companies. We offer best-in-class presentations from leaders in all parts of the Android ecosystem, including core development, embedded solutions augmented reality, business solutions and games.", city = city2)
